...
import com.pch.common.constant.WebSocketConstant;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        registry.enableSimpleBroker(WebSocketConstant.ENABLE_BROKER_QUEUE,
                WebSocketConstant.ENABLE_BROKER_TOPIC);
